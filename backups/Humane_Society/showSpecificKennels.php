...
<head>
    ...
    <body>
        ...
        <button id="employeelogin" onclick="location.href='insertKennel.html'">Insert Kennel</button>
                       ...
                       <form method="post" action = "showSpecificKennels.php">
                       Search (Kennel Number, Facility Number):
                ...
                <?php
                    ...
                    $select = "SELECT * FROM kennel WHERE Kennel_Number ='" . $_POST['criteria'] . "
                    OR Facility_Num = '" . $_POST['criteria'] . "'";
